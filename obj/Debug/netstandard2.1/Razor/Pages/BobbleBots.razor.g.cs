#pragma checksum "C:\Users\brady\Documents\GitHub\bradylangdale.github.io\Pages\BobbleBots.razor" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5c66423cbceb3390a5e569074d2065258a145e36"
// <auto-generated/>
...
#line 27 "C:\Users\brady\Documents\GitHub\bradylangdale.github.io\Pages\BobbleBots.razor"
    ...
    private BotScope UpdateBotScope(BotScope bot)
    {
        if (bot.name == "Bot1" && !scope2.busy)
        {
            ...
            scope1.output = bot.output;
            scope1.radar = bot.radar;

            try
            {
                bool result = botScript1.update();
            }
            catch (Exception e) { }
        ...
        if (bot.name == "Bot2" && !scope2.busy)
        {
            ...
            scope2.output = bot.output;
            scope2.radar = bot.radar;

            try
            {
                bool result = botScript2.update();
            }
            catch (Exception e) { }
